        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="deptid" id = "txt_search_roleid">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveEmps.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>生日：</td>
								<td>
				               <input readonly="readonly" placeholder="开始时间" id="txt_search_birthday" name="birthday" class="laydate-icon form-control layer-date"/>
								...
								<td>部门：</td>
								<td >
									<select class="form-control" name="deptid" id = "deptid" aria-required="true" required>

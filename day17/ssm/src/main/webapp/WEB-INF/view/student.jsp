...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="coourseid" id = "txt_search_roleid">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>用户名：</td>
								<td><input type="text" id="sname" name="name"
								...
								<td>
									<select class="form-control" name="grade" id = "grade" aria-required="true" required>
										<c:forEach items="${sList }" var="s">
										 	<option value="${s.grade }">${s.grade }</option>
										</c:forEach>
				                	</select>
								</td>
							</tr>
							<tr>
								<td>所选课程：</td>
								<td colspan="4">
									<select class="form-control" name="coourseid" id = "roleid" aria-required="true" required>
							...
							<tr>
								<td>入校时间:</td>
								<td>
									 <input id="entrytime" name="entrytime" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
						</table>
	...
	<div class="modal fade" id="modal_user_course" role="dialog" aria-labelledby="modal_user_course" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_course" method="post" action="addCourse.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>课程名称:</td>
								<td>
	...
	<div class="modal fade" id="bing" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body" id="bingtu" style="width:300px;height:300px;">
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            coourseid: $("#txt_search_roleid").val(),
	...
	$("#btn_exp").click(function(){
		location.href="${path}/student/exp.htm"
	});
	
	$("#btn_bing").click(function(){
		$('#bingtu').modal({backdrop: 'static', keyboard: false});

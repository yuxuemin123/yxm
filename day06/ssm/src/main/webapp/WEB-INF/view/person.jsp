...
<body class="gray-bg">
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 ...
                 <div class="col-sm-8">
                     ...
                     <input placeholder="结束时间"id="txt_search_end" name="stop" class="laydate-icon form-control layer-date"/>
                 </div>
	          </div>
		  	</div>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>特点：</td>
								<td>
									<input type="checkbox" id="expressTrait" name="expressTrait" value="篮球" aria-required="true" required/>篮球
									<input type="checkbox" id="expressTrait" name="expressTrait" value="钢琴" aria-required="true" required/>钢琴
									<input type="checkbox" id="expressTrait" name="expressTrait" value="萨克斯" aria-required="true" required/>萨克斯
									<input type="checkbox" id="expressTrait" name="expressTrait" value="电吉他" aria-required="true" required/>电吉他
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>入职时间：</td>
								<td>
							...
							<tr>
								...
								<td>所属公司：</td>
								<td colspan="4">
									<select class="form-control" name="expressTypeId" id = "expressTypeId">
										<option value="0">---请选择---</option>
										<c:forEach items="${roleList }" var="r">
										 	<option value="${r.id }">${r.expressName }</option>
										</c:forEach>
	...
	function initEditUser(getSelection){
		...
		if (getSelection.expressTrait!="" && getSelection.expressTrait!=null) {
			var expressTrait =getSelection.expressTrait;
			var expressTraitArr=expressTrait.split(",");
			for (var i = 0; i < expressTraitArr.length; i++) {
				$("input[value='"+expressTraitArr[i]+"']").prop("checked",true);
			}
		}

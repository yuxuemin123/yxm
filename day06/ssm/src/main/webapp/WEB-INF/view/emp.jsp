...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<input type="date" name="start" id="txt_search_start" >
					<input type="date" name="end" id="txt_search_end" >
				</div>
			 </div>
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveEmp.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>用户名：<input type="text" id="eName" name="eName"/></td>
								<td>生日：<input type="date" id="birthday" name="birthday"/></td>
							</tr>
							<tr>
								
								<td>
									性别：
									<input type="radio" id="gender" name="gender" value="男" checked="checked" aria-required="true" required/>男
									<input type="radio" id="gender" name="gender" value="女" aria-required="true" required/>女
								</td>
								
								<td>年龄：<input type="text" id="age" name="age"/></td>
							</tr>
							<tr>
								<td>
									头像：<input type="file" name="picFile" id="picFile">
								</td>
								<td>
									<img width="100px" height="100px" id="pic2">
								</td>
							</tr>
							<tr>
								<td>
									爱好：
									<input type="checkbox" name="hobby" value="篮球" id="hobby">篮球
									<input type="checkbox" name="hobby" value="足球" id="hobby">足球
									<input type="checkbox" name="hobby" value="钢琴" id="hobby">钢琴
									<input type="checkbox" name="hobby" value="吉他" id="hobby">吉他
								</td>
							</tr>
							<tr>
								<td colspan="4">
	...
	function initEditUser(getSelection){
		...
		$("#pic2").prop("src","/photo/"+getSelection.pic);
		$("#pic").val(getSelection.pic);
		var hobby = getSelection.hobby;
		//判断爱好不能为空
		if (getSelection.hobby==null) {
			getSelection.hobby="";
		}

				...
				<div class="input-group">
					...
					<select class="form-control" name="contentcategoryid" id = "txt_search_contentcategoryid">
						...
						<c:forEach items="${clist }" var="d">
						 	<option value="${d.contentcategoryid }">${d.categoryname }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td><input type="text" id="price" name="price"
									...
									<td>广告状态：</td>
								<td colspan="4">
									<select class="form-control" name="staus" id ="staus" aria-required="true" required>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
						<form id="personId" action="importContent.htm" method="post" enctype="multipart/form-data">

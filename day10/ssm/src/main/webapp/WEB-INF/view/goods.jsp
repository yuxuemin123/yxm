...
<body class="gray-bg">
			...
			<div class="col-lg-2">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="typeid" id = "txt_search_typeid">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<td>状态：</td>
								...
								<td>创建时间：</td>
								<td><input placeholder="创建时间" id="createtime" name="createtime" class="laydate-icon form-control layer-date"/></td>
								<td>&nbsp;&nbsp;</td>
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_user_goodstype" role="dialog" aria-labelledby="modal_user_goodstype" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_goodstype" method="post" action="reserveGoodstype.htm">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_goodstype_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
   		      ...
   		      $(form).ajaxSubmit({
   		    	...
   		    	success: function (data) {
   		    		...
   		    		if(data.success && !data.errorMsg ){
   		    			validator.resetForm();
   		    			$('#modal_user_goodstype').modal('hide');
   		    			$("#btn_search").click();
   		    		}else{
	    ...
	    //添加部门弹
	    $("#submit_form_goodstype_btn").click(function(){
	    	$("#form_goodstype").submit();
	    });
	});
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addGoodstype").click(function(){
	    		$('#modal_user_goodstype').modal({backdrop: 'static', keyboard: false});
				$('#modal_user_goodstype').modal('show');
	        });

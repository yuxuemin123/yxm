        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">分校名称 </span>
			      <input type="text" name="username" name="phone" name="address" class="form-control" id="txt_search_username" id="txt_search_address">
				</div>
			  </div>
			 <!--  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">联系方式 </span>
			      <input type="text" name="phone" class="form-control" id="txt_search_phone" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">详细地址 </span>
			      <input type="text" name="address" class="form-control" id="txt_search_address" >
				</div>
			  </div> -->
	...
	<div class="modal fade" id="modal_user_export" role="dialog" aria-labelledby="modal_user_export" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
				<button type="button" class="btn btn-danger"  id="del_export_btn">导出</button>
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
			</div>
		</div>

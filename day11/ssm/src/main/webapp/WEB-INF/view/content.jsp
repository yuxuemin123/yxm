...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveUser.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>创建时间：</td>
								<td>
									<input id="createtime" name="createtime" readonly="readonly" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
						</table>
    			...
    			$.ajax({
    			    ...
    			    success:function(res){
    			    	...
    			    	res.list.forEach(function(content) {
    			    		...
    			    		ydata.push({value:content.num,name:content.categoryname});
						});
    			    	if(res.success){
    			    		option = {
	    			    		    title: {
	...
	function initEditUser(getSelection){
		...
		$("#pic").prop("src","/photo/"+getSelection.picpath);
	}

...
<body class="gray-bg">
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						<input type="hidden" name="gId" id="hidden_txt_gId" value=""/>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$("#form_user").resetForm();
	    		document.getElementById("hidden_txt_gId").value='';
	...
	function initEditUser(getSelection){
		$('#hidden_txt_gId').val(getSelection.gId);

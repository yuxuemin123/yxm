...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>入校时间：</td>
								<td><input type="date" id="entrytime" name="entrytime"/></td>
							</tr>
						</table>
	...
	<!-- 添加老师 -->
	<div class="modal fade" id="modal_user_dept" role="dialog" aria-labelledby="modal_user_dept" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_dept" method="post" action="reserveDept.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>入校时间:</td>
								<td><input type="date" name="entrytime" id="entrytime"></td>
							</tr>
						</table>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addDept").click(function(){
	    		$("#form_dept").resetForm();
	    		$('#modal_user_dept').modal({backdrop: 'static', keyboard: false});
				$('#modal_user_dept').modal('show');
	        });
	    	...
	    	$("#btn_echarts").click(function(){
	    		...
	    		$.ajax({
	    		    ...
	    		    success:function(res){
	    		    	var xdata = new Array();
	    		    	var ydata = new Array();
	    		    	res.list.forEach(function(student){
	    		    		xdata.push(student.tname);
	    		    		ydata.push({value:student.num,name:student.tname});
	    		    	});

...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="mId" id = "txt_search_mId" aria-required="true" required>
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 ...
                 <div class="col-sm-8">
                     <input type="date" placeholder="开始时间" id="txt_search_start" name="start" class="laydate-icon form-control layer-date"/>
                     <input type="date" placeholder="结束时间"id="txt_search_end" name="end" class="laydate-icon form-control layer-date"/>
                 </div>
	          </div>
		  	</div>
					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>学生性别：</td>
								<td>
									<input type="radio" name="sSex" id="sSex" value="男" aria-required="true" required>男
									<input type="radio" name="sSex" id="sSex" value="女" aria-required="true" required>女
								</td>
							</tr>
							<tr>
								<td>学生爱好：</td>
								<td>
									<input type="checkbox" name="sHobby" id="sHobby" value="篮球" aria-required="true" required>篮球
									<input type="checkbox" name="sHobby" id="sHobby" value="足球" aria-required="true" required>足球
									<input type="checkbox" name="sHobby" id="sHobby" value="排球" aria-required="true" required>排球
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>学生生日：</td>
								<td>
									<input type="date" name="sBirth" id="sBirth" aria-required="true" required>
								</td>
							</tr>
							<tr>
								<td>专业名称：</td>
	...
	<!-- 新增专业-->
	<div class="modal fade" id="modal_user_addMajor" role="dialog" aria-labelledby="modal_user_addMajor" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form_import" action="importStu.htm" method="post" enctype="multipart/form-data">
						<input type="file" name="stuExcel">								
					</form>
				</div>
				<div class="modal-footer">
    		...
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	...
   		    	success: function (data) {
   		    		...
   		    		if(data.success && !data.errorMsg ){
   		    			validator.resetForm();
   		    			$('#modal_user_addMajor').modal('hide');
   		    			$("#btn_search").click();
   		    		}else{
   		    			$("#select_message").text(data.errorMsg);
   		    			$("#alertmod_table_user_mod").show();
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addMajor").click(function(){
	    		$("#form_major").resetForm();
	    		$('#modal_user_addMajor').modal({backdrop: 'static', keyboard: false});
				$('#modal_user_addMajor').modal('show');
	        });
	        
	    	$("#btn_edit").click(function(){
	    		var getSelections = $('#table_user').bootstrapTable('getSelections');
	    		$("input:checkbox[name='sHobby']").prop("checked",false);
